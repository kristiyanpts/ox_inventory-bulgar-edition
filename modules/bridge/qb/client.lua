...
RegisterNetEvent("ox_inventory:client:openSafeInventory", function()
	TriggerServerEvent("ox_inventory:server:openSafeInventory")
	QBCore.Functions.GetPlayerData(function(data)
		print(data.citizenid)
		exports.ox_inventory:closeInventory()
		Wait(200)
		exports.ox_inventory:openInventory("stash", "PersonalStash-"..data.citizenid)
		-- exports.ox_inventory:setStashTarget("PersonalStash-"..data.citizenid)
	end)
end)